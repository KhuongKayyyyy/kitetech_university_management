            ...
            <form className="space-y-4">
              <div className="flex flex-col gap-4 sm:flex-row">
                <div className="flex-1 space-y-2">
                  ...
                  <Input id={`${id}-first-name`} placeholder="Matt" defaultValue={student.name} type="text" required />
                </div>
                <div className="flex-1 space-y-2">
                  <Label htmlFor={`${id}-last-name`}>Last name</Label>
                  <Input id={`${id}-last-name`} placeholder="Welsh" defaultValue={student.name} type="text" required />
                </div>
              </div>
